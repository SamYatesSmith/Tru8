...
class TestDeduplication:
        ...
        evidence = [
            {
                ...
                "snippet": "Climate change is affecting polar bears.",
            },
            {
    ...
    def test_high_similarity_removal(self, deduplicator):
        """Test: Near-duplicates (95%+ similar, true syndication) removed"""
        evidence = [
            {
                "url": "https://site1.com/a",
                "snippet": "The stock market rose by 5% today in early trading.",
            },
            {
                "url": "https://site2.com/b",
                "snippet": "The stock market rose by 5% today in early trading.",
            },  # Exact copy (syndication)
            {
                "url": "https://site3.com/c",
                "snippet": "Unemployment rates fell to 3%.",
            },  # Different
        ]
    ...
    def test_syndicated_content_detection(self, deduplicator):
        ...
        evidence = [
            {
                "url": "https://original.com/a",
                "snippet": "BREAKING: Major event occurred today.",
            },
            {
                "url": "https://syndicated.com/b",
                "snippet": "BREAKING: Major event occurred today.",
            },
        ]
