...
class TestSourceCredibilityService:
    ...
    def test_matches_wildcard_edu_pattern(self):
        ...
        result = self.service.get_credibility(
            "Stanford", "https://stanford.edu/research"
        )
    ...
    def test_matches_scientific_journal(self):
        ...
        result = self.service.get_credibility(
            "Nature", "https://nature.com/articles/123"
        )
    ...
    def test_matches_news_tier2(self):
        ...
        result = self.service.get_credibility(
            "Guardian", "https://theguardian.com/politics"
        )
    ...
    def test_matches_factcheck_organization(self):
        ...
        result = self.service.get_credibility(
            "Snopes", "https://snopes.com/fact-check/test"
        )

        assert result["tier"] == "factcheck"
        assert result["credibility"] == 0.87

    def test_matches_legal_domain(self):
        """Should match legal and court system sources"""
        result = self.service.get_credibility(
            "US Supreme Court", "https://supremecourt.gov/opinions/123"
        )
    ...
    def test_matches_legal_database(self):
        ...
        result = self.service.get_credibility(
            "BAILII", "https://bailii.org/uk/cases/123"
        )
    ...
    def test_matches_uk_judiciary(self):
        ...
        result = self.service.get_credibility(
            "UK Judiciary", "https://judiciary.uk/judgments"
        )
    ...
    def test_matches_technical_standards(self):
        ...
        result = self.service.get_credibility(
            "IETF", "https://ietf.org/rfc/rfc9000.txt"
        )
    ...
    def test_matches_technical_documentation(self):
        """Should match official technical documentation (via domain config)"""
        result = self.service.get_credibility(
            "IETF", "https://ietf.org/rfc/rfc9000.txt"
        )
    ...
    def test_matches_medical_professional_body(self):
        ...
        result = self.service.get_credibility(
            "AMA", "https://ama-assn.org/guidelines/ethics"
        )
    ...
    def test_matches_financial_data_provider(self):
        """Should match financial regulatory bodies"""
        result = self.service.get_credibility("SEC", "https://sec.gov/edgar/filing/123")
    ...
    def test_matches_central_bank(self):
        ...
        result = self.service.get_credibility(
            "Federal Reserve", "https://federalreserve.gov/policy"
        )
    ...
    def test_blacklist_low_credibility(self):
        ...
        result = self.service.get_credibility(
            "InfoWars", "https://infowars.com/article"
        )
    ...
    def test_tabloid_moderate_credibility(self):
        ...
        result = self.service.get_credibility(
            "Daily Mail", "https://dailymail.co.uk/news"
        )
    ...
    def test_general_fallback_for_unknown_domain(self):
        ...
        result = self.service.get_credibility(
            "Unknown Blog", "https://randomblog.com/post"
        )
    ...
    def test_exact_match_takes_precedence(self):
        ...
        assert result["tier"] == "academic"
        assert (
            "mit.edu" in str(result["reasoning"]).lower()
            or "academic" in str(result["reasoning"]).lower()
        )
    ...
    def test_path_pattern_matches_sports_section(self):
        ...
        self.service.clear_cache()
        result = self.service.get_credibility(
            "BBC Sport", "https://bbc.co.uk/sport/football/article-123"
        )
    ...
    def test_path_pattern_takes_precedence_over_domain(self):
        ...
        sport_result = self.service.get_credibility(
            "BBC", "https://bbc.co.uk/sport/tennis"
        )
        assert sport_result["tier"] == "sports_news"

        # BBC News should hit news_tier1 (domain pattern - no path match)
        self.service.clear_cache()
        news_result = self.service.get_credibility(
            "BBC", "https://bbc.co.uk/news/politics"
        )
    ...
    def test_guardian_football_path_pattern(self):
        ...
        self.service.clear_cache()
        result = self.service.get_credibility(
            "Guardian", "https://theguardian.com/football/premier-league"
        )
    ...
    def test_guardian_politics_falls_back_to_news(self):
        ...
        self.service.clear_cache()
        result = self.service.get_credibility(
            "Guardian", "https://theguardian.com/politics/article"
        )
    ...
    def test_path_caching_separates_sections(self):
        ...
        # First: BBC Sport
        sport_result = self.service.get_credibility(
            "BBC", "https://bbc.co.uk/sport/football"
        )
        assert sport_result["tier"] == "sports_news"

        # Second: BBC News (should NOT return cached sport result)
        news_result = self.service.get_credibility(
            "BBC", "https://bbc.co.uk/news/world"
        )
        assert news_result["tier"] == "news_tier1"
