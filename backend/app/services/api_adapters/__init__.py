...
- economic: ONS, FRED, AlphaVantage, Marketaux
- health: PubMed, WHO
- climate: NOAA, WeatherAPI
...
from .economic import ONSAdapter, FREDAdapter, AlphaVantageAdapter, MarketauxAdapter
from .health import PubMedAdapter, WHOAdapter
from .climate import NOAAAdapter, WeatherAPIAdapter
from .legal import GovUKAdapter, HansardAdapter, GovInfoAdapter
