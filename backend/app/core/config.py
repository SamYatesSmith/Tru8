...
class Settings(BaseSettings):
    ...
    JURISDICTION_ADAPTERS: str = Field(
        '{"uk": ["ONS Economic Statistics", "UK Parliament Hansard", "GOV.UK Content API", "Companies House", "UK Legislation"], "us": ["FRED", "GovInfo.gov", "Library of Congress"], "eu": [], "global": ["Semantic Scholar", "OpenAlex", "Wikipedia", "PubMed", "NOAA CDO", "WeatherAPI", "Open-Meteo", "GBIF", "World Bank", "Internet Archive", "Wikidata", "Marketaux", "Transfermarkt", "Football-Data.org"]}',
