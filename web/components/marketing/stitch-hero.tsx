        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-zinc-500 mb-12 max-w-xl leading-relaxed">
              Submit a claim or article. Tru8 gathers evidence from government data, news, academic papers, and official records — then organises it so you can explore it four ways.
            </p>
