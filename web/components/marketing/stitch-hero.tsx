        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            <div className="font-mono text-[10px] tracking-[0.3em] uppercase text-zinc-400 mb-6">
              Technical &amp; Clinical Specification v2.0
            </div>
            ...
            <p className="text-lg md:text-xl text-zinc-500 mb-12 max-w-xl leading-relaxed">
              AI-powered evidence research across 14+ source types. Technical, clinical, and regulatory-grade analysis for architectural design language.
            </p>
