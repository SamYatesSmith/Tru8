# case-002 — Review Sheet

**Claim**: The Great Wall of China is visible from space with the naked eye.
**Type**: empirical | **Model**: gemini-2.5-flash-lite | **Prompt hash**: `5e8a5a5ad98b`
...
**Mapper reasoning**: Mentions observations by NASA astronauts from low Earth orbit, indicating a vantage point in space exists for observation.
...
**Mapper reasoning**: Discusses what astronauts see from low Earth orbit, such as aboard the International Space Station, confirming a vantage point in space for observation.
...
**Mapper reasoning**: States that artificial structures are visible from space, implying that space is a vantage point from which observations can be made.
...
*Uncertainty*: While some sources claim the Great Wall is visible from space, multiple astronaut accounts and scientific explanations indicate it is not easily distinguishable without aid and is rarely visible due to low contrast.

### ev-b0e690dce64c -> `challenges`
...
**Mapper reasoning**: Explicitly states that the claim of the Great Wall being seen from the moon with the naked eye is an 'erroneous speculation' that has been 'proved false'.
...
**Mapper reasoning**: Notes that the Great Wall is not easily distinguishable without visual aid, contradicting the idea that it can be perceived with the naked eye from space.
...
**Mapper reasoning**: States that the myth of the Great Wall being seen from space was 'completely debunked' as humans ventured into space.
...
**Mapper reasoning**: Mentions that astronauts have consistently pushed back on the idea, noting that from the Moon, specific landmarks are not easily discernible without aid.
...
**Mapper reasoning**: Asserts that the Great Wall isn't what astronauts see from orbit, implying it's not visible with the naked eye.
...
**Mapper reasoning**: States the Great Wall of China is 'Rarely visible due to low contrast' from low Earth orbit, directly challenging its visibility with the naked eye.
...
**Mapper reasoning**: This evidence directly contradicts itself, first stating the Great Wall is visible from space with the naked eye, then immediately questioning it by saying 'You can 100% see the Great Wall of China from ...' but the ellipsis suggests incompleteness or doubt.
...
**Mapper reasoning**: This evidence discusses artificial structures visible from space but does not specify if the Great Wall is among them or if it's visible with the naked eye.
