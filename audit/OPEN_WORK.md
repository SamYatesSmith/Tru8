...
> **2026-09-08 — Candidate decomposition corrected; clinical mapping gate still fails.** Generic scope instructions plus removal of the conflicting cause/effect split produced faithful elements in six single and six batch outputs across three claims. Eight synthetic mapping controls passed. Repeated real-source mappings still misclassify progression and observational evidence, so candidate activation remains withheld; no 8/10 claim. All 21/16 source inputs were preserved. Focused tests: 105 passed; final replay matched 185/1/13/2 with zero cassette drift. Next: trace initial/completion scope errors, snippet-only coverage and passage conflicts without discarding sources. Details: [scope correction](2026-09-08_scope_correction.md).
