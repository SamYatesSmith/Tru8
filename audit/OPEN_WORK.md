...
3. **Bench re-record — founder go, ~£0.80:** Build A + the fetch deadline re-keyed every wired cassette; `python scripts/replay_bench.py --all --update-golden` with docker up; keep the 018F/0005 must-fire pins by hand (2026-08-27 method).
