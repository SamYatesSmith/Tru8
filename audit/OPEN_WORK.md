...
> **2026-09-08 — Public/export evidence-snapshot identity implemented.** Owner/public responses and PDFs now identify the loaded claims/evidence snapshot and attach a retained revision ID only on an exact stored-content match. Historical verification links select that revision; unmatched and unsigned records are disclosed. PDF presentation no longer mutates claim maps. Backend 75 checks passed (2 native-render skips covered by a separately rendered/visually inspected WeasyPrint sample); web 186 full-suite checks plus 4 final verification checks and TypeScript passed; replay matched 185/1/13/2, zero drift. No deployment or candidate activation. Next: live strengthening/share/export acceptance and broader semantic/operational validation from the original plan. Details: [public/export identity](2026-09-08_report_identity.md).
