...
> **2026-09-08 — Bounded final scope review passes targeted frozen-source repeats; activation withheld.** Candidate v9 reviews directional labels after completion/passage review, including snippets, preserving original interpretations and sources. Explicit mismatches or documented unestablished scope become context; malformed/failed reviews retain earlier labels. A generic named-study identifier guard prevents inferring an absent trial identity. Frontend shows coverage, scoped sources and superseded conflicts. Both final repeats retain 21/16 source inputs, scope progression evidence to context and retain six SELECT supports while scoping the unidentified observational snippet. Checks: 124 backend, 190 web and TypeScript passed; final replay matched 185/1/13/2 with zero cassette drift. Candidate remains OFF; no 8/10 claim. Details: [final scope review](2026-09-08_relationship_scope_review.md).
