...
> **2026-09-08 — evidence-quality steps 1–4b and provenance foundation (5a) locally verified.** Fresh extractions retain bounded exact excerpts, offsets/fingerprint and the original snippet alongside generated facts; the source panel distinguishes them. Initial research now also prevents stale snippets from bypassing distilled facts. Backend 55 focused checks; web 162 plus TypeScript; replay matches 185/1/13/2 with zero cassette drift. Next: feed element-selected passages to mapping and validate passage/element relationships (5b). Step 5 as a whole, revision-change presentation and live acceptance remain open. Scope and deployment requirements: [implementation register](2026-09-07_evidence_quality_implementation.md). Existing commercial/outreach changes are preserved separately; this programme does not authorise deployment, account deletion or outreach.
