...
> **2026-09-08 — Finished-report pilot complete: clinical scope and decomposition remain blockers.** Three live default local reports completed with 11/21/16 sources in 41/64/35 seconds; owner/public ledgers and snapshot identities agree. Venus retained one useful element. Creatine added a vacuous absorption premise and used progression evidence against prevention; SELECT lost relative-effect wording, added exactness and mapped an observational association as trial-causal support. Source-origin/access issues also remain. Restricted-network fallback runs are excluded. Replay matched 185/1/13/2. Next: bounded generic decomposition and population/endpoint/study-design correction on frozen cases, without reducing the source pool. Candidate flags remain OFF; 8/10 is not established. Details: [finished-report pilot](2026-09-08_finished_report_pilot.md).
